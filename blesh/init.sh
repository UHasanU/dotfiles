...
## center and the top right corner, respectively.  The faces "vbell",
## "vbell_erase", and "vbell_flash" specify the graphic style of the vbell, the
## one after vbell is erased, and the one used to blink the vbell,
## respectively.
