function fish_vi_key_bindings --description 'vi-like key bindings for fish'
    ...
    bind -s --preset gk backward-word
    bind -s --preset gK backward-bigword
    bind -s --preset w forward-word forward-single-char
    bind -s --preset W forward-bigword forward-single-char
    bind -s --preset k forward-single-char forward-word backward-char
    bind -s --preset K forward-bigword backward-char
    ...
    bind -s --preset dlw forward-single-char forward-single-char backward-word kill-word
    bind -s --preset dlW forward-single-char forward-single-char backward-bigword kill-bigword
    ...
    bind -s --preset dk kill-word
    bind -s --preset dK kill-bigword
    bind -s --preset db backward-kill-word
    bind -s --preset dB backward-kill-bigword
    bind -s --preset dgk backward-kill-word
    bind -s --preset dgK backward-kill-bigword
    ...
    bind -s --preset dl backward-jump-till and repeat-jump-reverse and begin-selection repeat-jump kill-selection end-selection
    ...
    bind -s --preset -m insert clw forward-single-char forward-single-char backward-word kill-word repaint-mode
    bind -s --preset -m insert clW forward-single-char forward-single-char backward-bigword kill-bigword repaint-mode
    ...
    bind -s --preset -m insert ck kill-word repaint-mode
    bind -s --preset -m insert cK kill-bigword repaint-mode
    bind -s --preset -m insert cb backward-kill-word repaint-mode
    bind -s --preset -m insert cB backward-kill-bigword repaint-mode
    bind -s --preset -m insert cgk backward-kill-word repaint-mode
    bind -s --preset -m insert cgK backward-kill-bigword repaint-mode
    ...
    bind -s --preset -m insert cl backward-jump-till and repeat-jump-reverse and begin-selection repeat-jump kill-selection end-selection repaint-mode
    ...
    bind -s --preset ylw forward-single-char forward-single-char backward-word kill-word yank
    bind -s --preset ylW forward-single-char forward-single-char backward-bigword kill-bigword yank
    ...
    bind -s --preset yk kill-word yank
    bind -s --preset yK kill-bigword yank
    bind -s --preset yb backward-kill-word yank
    bind -s --preset yB backward-kill-bigword yank
    bind -s --preset ygk backward-kill-word yank
    bind -s --preset ygK backward-kill-bigword yank
    ...
    bind -s --preset yi begin-selection kill-selection yank end-selection
    bind -s --preset yl backward-jump-till and repeat-jump-reverse and begin-selection repeat-jump kill-selection yank end-selection
    ...
    bind -s --preset -M visual gk backward-word
    bind -s --preset -M visual gK backward-bigword
    bind -s --preset -M visual w forward-word
    bind -s --preset -M visual W forward-bigword
    bind -s --preset -M visual k forward-word
    bind -s --preset -M visual K forward-bigword
